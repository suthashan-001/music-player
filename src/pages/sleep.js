...
import Lullabies from "../music-file/lullabies";
...
const Sleep = (props) => {
  // state management
  const [state, dispatch] = React.useReducer(Lullabies_reducer, {
    songs: Lullabies,
    playOrder: [],
  });
  ...
  return (
    <div className="page page-background">
      ...
      {/* Lullabies */}
      <h1 className="pannel-title dub-title">Baby Lullabies</h1>
...
function Lullabies_reducer(state, action) {
  switch (action.type) {
    case "SHUFFLE_SONGS": {
